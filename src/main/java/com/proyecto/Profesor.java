...
public class Profesor extends Usuario {
    ...
    public Profesor(String codigo, String cedula, String nombres, String apellidos, String usuario, String contrasena, String correo, String facultad, String[] materias) {
   ...
   private void reservarEspacio() {
    // Mostrar solo los espacios que el profesor puede reservar
    ...
    for (Espacio espacio : Main.espacios) {
        if (espacio.isDisponible() && 
            ((opcion == 1 && espacio.getTipo().equals("AULA")) ||
             (opcion == 2 && espacio.getTipo().equals("LABORATORIO")) ||
             (opcion == 3 && espacio.getTipo().equals("AUDITORIO")))) {
    ...
    if (!espaciosDisponibles.isEmpty()) {
        ...
        if (espacioSeleccionado >= 1 && espacioSeleccionado <= espaciosDisponibles.size()) {
            ...
            Reserva nuevaReserva = new Reserva(codigoReserva, this.getCodigo(), this.getCedula(), new Date(),
                                               ...
                                               "Reserva de " + espacioElegido.getNombre(), "APROBADO");
